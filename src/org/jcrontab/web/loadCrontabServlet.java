...
//		}
//		
		String realfilepath = path+"\\"+propz;
		String tsprops = this.getServletContext().getRealPath(realfilepath);
		System.out.println(realfilepath);
		
		System.out.println(tsprops);
		...
		try {
		    InputStream input = createPropertiesStream(realfilepath);
		    propObj.load(input);
		    propObj.setProperty("org.jcrontab.data.file", path+(propObj.getProperty("org.jcrontab.data.file")));
		    propObj.setProperty("org.jcrontab.log.log4J.Properties", path+(propObj.getProperty("org.jcrontab.log.log4J.Properties")));
